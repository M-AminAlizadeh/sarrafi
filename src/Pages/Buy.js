	...
	return (
		<div className="buy-page-container" style={{ display: "flex" }}>
			...
			>
				...
				<ul className="buy-page-list" dir="rtl">
					...
					<li>
						...
						صعود یا سقوط ارزش را به صورت ناگهانی تجربه کنند، اکس اونیکس همانگونه
						که منفعتی در قبال افزایش ارزش آن نمی برد، مسئولیتی هم در قبال سقوط
						قیمت آن نخواهد داشت.
					</li>
					<br />
					<li>
						اکس اونیکس تنها در مورد پرداخت مبلغ سفارش مسئولیت دارد و وظیفه
						پیگیری های بعدی سفارش، برعهده شماست.
					</li>
					<br />
					<li>
					...
					<br />
					<li>
						وبسایت اکس اونیکس برای سایت هایی که فعالیت آن ها بر خلاف قوانین
						جمهوری اسلامی ایران است خدماتی ارائه نمیدهد
					</li>
				</ul>
			</div>
			<div
			...
			>
				...
				<div className="buy-page-input-container-first-row">
					<span>انتخاب ارز</span>
					<input className="buy-page-input"></input>
					<div
						style={{
				...
				<div>
					<span>مقدار ارز</span>
					<input type="number" className="buy-page-input"></input>
					<div>
						<span>به تومان</span>
						<input type="number" className="buy-page-input"></input>
					</div>
